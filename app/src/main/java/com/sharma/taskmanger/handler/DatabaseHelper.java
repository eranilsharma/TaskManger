package com.sharma.taskmanger.handler;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    // create table task sql query
    private String CREATE_TASK_TABLE = "CREATE TABLE " + TABLE_TASK + "("
            + COLUMN_TASK_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_USER_ID + " INTEGER ," + COLUMN_TASK_TITLE + " TEXT,"
    ...
    public List<Task> getAllTask() {
        ...
        if (cursor.moveToFirst()) {
            do {
                Task task = new Task();
                task.setUserId(Integer.parseInt(cursor.getString(cursor.getColumnIndex(COLUMN_USER_ID))));
                task.setTaskTitle(cursor.getString(cursor.getColumnIndex(COLUMN_TASK_TITLE)));
                task.setTaskDesc(cursor.getString(cursor.getColumnIndex(COLUMN_TASK_DESC)));
                // Adding user record to list
                taskList.add(task);
            } while (cursor.moveToNext());
        }
    ...
    public List<Task> getUserTask(int userId) {
        SQLiteDatabase db = this.getReadableDatabase();
        String sql = "SELECT * FROM " +DatabaseHelper.TABLE_TASK
        ...
        if (cursor.moveToFirst()) {
            ...
            do {
                Task task=new Task();
                task.setUserId(Integer.parseInt(cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_USER_ID))));
                task.setTaskTitle(cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_TASK_TITLE)));
                task.setTaskDesc(cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_TASK_DESC)));
                tasksList.add(task);
            }
            while (cursor.moveToNext());
        }
    ...
    public User getUser(String email) {
        ...
        if (cursor.moveToFirst()) {
            ...
            user.setUserType(cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_USER_TYPE)));
            }
        cursor.close();
        db.close();
        return user;
     ...
     * This method is to delete user task record
     *
     * @param task
     */
